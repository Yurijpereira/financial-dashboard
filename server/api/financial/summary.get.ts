export default defineEventHandler((event) => {
  ...
  console.log('API Filters:', { startDate, endDate, customers, regions, products })
  ...
  return {
    ...
    salesSeries: [
      { date: '2025-12-01', value: Math.round(8200 * filterMultiplier) },
      { date: '2025-12-02', value: Math.round(9100 * filterMultiplier) },
      { date: '2025-12-03', value: Math.round(7600 * filterMultiplier) },
      { date: '2025-12-04', value: Math.round(10400 * filterMultiplier) },
      { date: '2025-12-05', value: Math.round(9800 * filterMultiplier) },
      { date: '2025-12-06', value: Math.round(11200 * filterMultiplier) },
      { date: '2025-12-07', value: Math.round(10100 * filterMultiplier) },
    ],
    topCustomers: [
